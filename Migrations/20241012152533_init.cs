        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Is_story = table.Column<byte>(type: "TINYINT", nullable: false),
                    Create_at = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMembers_Groups_GroupChatId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMessenges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupMessenges_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupMessenges_GroupMessenges_ReplyToId",
                        column: x => x.ReplyToId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Content_gif = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostViewers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reaction_at = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMessenges_GroupChatId",
                table: "GroupMessenges",
                column: "GroupChatId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMessenges_ReplyToId",
                table: "GroupMessenges",
                column: "ReplyToId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMessenges_SenderId",
                table: "GroupMessenges",
                column: "SenderId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "MessengeMediaContents",
                column: "MessengeId");

            migrationBuilder.CreateIndex(
                name: "IX_Messenges_ReceiverId",
                table: "Messenges",
                column: "ReceiverId");
